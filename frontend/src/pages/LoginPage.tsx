    ...
    <div className="flex h-full items-center justify-center bg-surface-dim">
      <div className="w-full max-w-sm rounded-xl border border-border bg-surface p-8 shadow-lg">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-text">Agent Chat</h1>
        ...
        <button
          onClick={login}
          className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#24292f] px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-[#32383f]"
        >
